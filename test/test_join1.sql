...
select * from student_info INNER JOIN student_grades ON student_info.id = student_grades.id;
select * from student_info JOIN student_grades ON student_info.name = student_grades.name;

select * from student_info JOIN student_grades ON student_info.id = student_grades.id, student_info.name = student_grades.name;
select * from student_info JOIN student_grades ON student_info.id = student_grades.id, student_info.name = student_grades.name WHERE student_grades.score > 60;